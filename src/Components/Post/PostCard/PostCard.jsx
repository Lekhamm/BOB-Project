...
const PostCard = ({
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center w-full border bg-gray-100 rounded-md">
        <div className="flex justify-between items-center w-full  py-4 px-5">
          <div className="flex items-center">
            <img
              className="w-12 bg-gray-100 h-12 rounded-full shadow-md"
        ...
        <div className="flex justify-between py-2 items-center border-b border-bg-gray-100 mb-4"></div>
        <div className="border bg-gray-100 border-t w-full">
          <div className="w-full flex items-center bg-gray-100 px-5">
